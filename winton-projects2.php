        ...
        <div class="pure-menu">
            ...
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item" class="menu-item-divided pure-menu-selected">
                    <a href="winton-projects2.php" class="pure-menu-link  selected" style = >Projects</a>
                </li>
...
<div class=" col-xs-offset-1 col-xs-10  col-sm-offset-0  col-sm-9 sep">  
     ...
     <div class="w3-container background w3-card-2 animated fadeInDown">
      <h1 class="text w3-padding-16"><i class="fa fa-code-fork fa-fw w3-margin-right w3-xxlarge main animated fadeInDownBig"></i><b>Projects</b></h1>
</div>
    <div class="w3-container  card  background w3-margin-top animated fadeInUp">
    
    <h6 class="main">Here's some sample code from some of the projects I've completed over the years. Click on a github icon to go to that project's repo! </h6>
    <div>
    
 <h3 class="text w3-padding-16">  <a href="https://www.github.com/MartinWinton/rwhois" style="text-decoration: none" target="_blank"><i class="fa fa-github w3-hover-opacity  w3-margin-right main w3-xxlarge""></i></a>Rwhois Database Manager</h3>
       <input id="toggle2" type="checkbox" class="switch" >
  <label for="toggle2"><i id="drop" class="fa fa-chevron-up hvr-grow main w3-margin-right animated flash" ></i> </label>
     <i class="devicon-php-plain  w3-margin-right w3-xlarge main"></i>
     <div id="expand">
 ...
 <h3 class="text w3-padding-16">  <a href="https://www.github.com/MartinWinton/TwitterProject" style="text-decoration: none" target="_blank"><i class="fa fa-github w3-hover-opacity  w3-margin-right main w3-xxlarge""></i></a>Twitter Sentiment Analysis Project </h3> 
       <input id="toggle3" type="checkbox"  class="switch">

  <label for="toggle3"><i id="drop" class="fa fa-chevron-up hvr-grow main w3-margin-right animated flash" ></i> </label>
      <i class="devicon-java-plain w3-margin-right w3-xlarge main"></i>
     <div id="expand">
<script src="https://gist.github.com/MartinWinton/619b76fafa35eee1fd4a4f858525f76f.js"></script>
 ...
 <h3 class="text w3-padding-16">  <a href="https://www.github.com/MartinWinton/encoder-decoder" style="text-decoration: none" target="_blank"><i class="fa fa-github w3-hover-opacity  w3-margin-right main w3-xxlarge""></i></a>Encoder/Decoder in Binary, Hexadecimal, and Base64 </h3> 
       <input id="toggle4" type="checkbox" class="switch" >

    
       
  <label for="toggle4"><i id="drop" class="fa fa-chevron-up hvr-grow main w3-margin-right animated flash" ></i> </label>
      <i class="devicon-php-plain w3-margin-right w3-xlarge main"></i>
     <div id="expand">
   ...
   <div class=" col-xs-offset-2 col-xs-8  col-sm-offset-0 col-sm-3 ">
      ...
      <div class="background w3-text-white animated fadeInRight" style="padding-bottom: 5px">
    ...
    <input id="toggle" type="checkbox"  name="check4" class="switch">
