...
<div class="w3-content w3-margin-top" style="max-width:1400px;">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <h1 class="w3-text-white w3-padding-16"><i class="fa fa-pencil fa-fw w3-margin-right w3-xxlarge w3-text-amber"></i>Blog</h1>
</div>
...
if($rowss == Null){
$rowss['blog_title'] = "No post yet!";
$rowss['datetime'] = "No post yet!";
$rowss['blog_content'] = "No post yet!";
}
...
?>
  ...
  <div class="w3-container w3-black w3-margin-top">
          ...
          <h6 class="w3-text-amber"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $rowss['datetime'];?></span></h6>
